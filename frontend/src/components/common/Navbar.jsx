...
export default function Navbar() {
    ...
    const handleLogout = () => {
        ...
        if (window.confirm('¿Estás seguro de que deseas cerrar sesión?')) {
            AuthService.logout();
            // La redirección se maneja en AuthService.logout()
        }
    };
                    ...
                    <div className="flex items-center space-x-4">
                        {isAuthenticated ? (
                            <>
                                ...
                                <div className="relative">
                                    <button 
                                        ...
                                        className="flex items-center space-x-2 text-white hover:text-emerald-100 focus:outline-none"
                                    >
                            ...
                            <div className="flex items-center space-x-4">
                                <Link
                                    to="/login"
                                    className="px-4 py-2 text-emerald-600 bg-white rounded-lg hover:bg-emerald-50 transition font-medium shadow-sm"
                                >
                                    Iniciar Sesión
                                </Link>
                                <Link
                                    to="/register"
                                    className="px-4 py-2 bg-emerald-800 text-white rounded-lg hover:bg-emerald-900 transition font-medium shadow-sm"
                                >
                                    Registrarse
                                </Link>
                            </div>
